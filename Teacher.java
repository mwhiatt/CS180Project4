...
public class Teacher {
    ...
    public static void deleteCourse(String courseName) {
        try {
            ...
            //READING IN ALL THE COURSES, THEN FINDING THE NAME AND DELETING, THEN REWRITING THE FILE
        ...
        //SEARCHING FOR ALL QUIZZES INSIDE courseName + Quizzes, then calling deleteQuiz
        try {
        ...
        //Deleting entire file with all Quiz names. Finished using the file to find all quizzes, so can delete now.
    ...
    public static void deleteQuiz(String courseName, String quizName) {
        try {
            ...
            BufferedReader bfrSubmissions = new BufferedReader(new FileReader(courseName + quizName +
                    "Submissions.txt"));
    ...
    public static void editQuiz(Scanner input, String quizName, String courseName) {
        ...
        try {
            ...
            // first boolean to make sure valid input, second to make sure the requested question is an available
            // question.
    ...
    public static void viewSubmission(String courseName, String quizName, String submissionName) {
        try {
            BufferedReader bfrForViewing = new BufferedReader(new FileReader(courseName + quizName + submissionName + ".txt"));
            String details = bfrForViewing.readLine();
            while (details != null) {
                System.out.println(details);
                details = bfrForViewing.readLine();
            }
            bfrForViewing.close();
        } catch (FileNotFoundException e) {
            e.printStackTrace();
